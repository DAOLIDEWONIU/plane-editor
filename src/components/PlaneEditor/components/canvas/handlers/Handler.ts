...
class Handler implements HandlerOptions {
  ...
  public propertiesToInclude?: string[] = propertiesToInclude;
  public workareaOption?: WorkareaOption = workareaOption;
  public canvasOption?: CanvasOption = canvasOption;
  public gridOption?: GridOption = gridOption;
  public objectOption?: FabricObjectOption = objectOption;
  public guidelineOption?: GuidelineOption = guidelineOption;
  ...
  public saveCanvasImage = (
    option = { name: '平面图', format: 'png', quality: 1 },
  ) => {
